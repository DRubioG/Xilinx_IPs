...
proc create_ipi_design { offsetfile design_name } {
	...
	set AXI_TIMER_0 [ create_bd_cell -type ip -vlnv user.org:user:AXI_TIMER:1.0 AXI_TIMER_0 ]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:AXI_TIMER:1.0]]]]
